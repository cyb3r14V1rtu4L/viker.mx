...
class Paginador
{
    ...
    public function paginar($count, $pagina = false, $limite = false, $paginacion = false)
    {
	...
	public function getView($vista,$function='')
	{
		$rutaView = ROOT . 'templates' . DS . 'pagination' . DS . $vista . '.php';
