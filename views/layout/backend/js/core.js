...
$(document).ready(function () {
    ...
    $('#my-task-list').click(function(){
        ...
        $('.popover-content').addClass('scrollbar-dynamic');
...
function blockUI(el,size) {
    ...
    $(el).block({
        message: '<div class="fa fa-spinner fa-spin" style="font-size:'+size+'px; position:absolute; top: 50%"></div>',
        css: {
            border: 'none',
            padding: '2px',
            backgroundColor: 'none'
...
function preview(id){
    ...
    var modal_url= '/properties/preview/'+id;
    var modal_title='Preview';
    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            $('#preview_modal').on('shown.bs.modal', function() {
                ...
                $('#slider').flexslider({
                    ...
                    start:function(slider){
                        ...
                        $('#carousel .flex-direction-nav').css({visibility:'hidden'});
            ...
            $('#preview_content_modal').html(json.html);
            loadMap();
